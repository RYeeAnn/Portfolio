...
function About() {
    ...
    const resumeLink = "https://drive.google.com/file/d/1zirBmpLpP_E7OyL_aVABLQwCwMv9HklG/view?usp=sharing";
                        ...
                        <img className='about__image' src={ryan} alt="Ryan" />
                            <div className="about__information">
                                ...
                                <div className="about__text">
                                    ...
                                    <p>Currently, I’m a Software Developer Intern at Atria Community, where I’ve built APIs, led frontend projects, and improved team processes. I have hands-on experience with Python, JavaScript, and C#, building and maintaining RESTful APIs, optimizing application performance, and collaborating closely with UX/UI designers. I’m particularly skilled in front-end technologies, with a focus on React.</p>
                                    ...
                                    <p>Outside of work, I enjoy playing volleyball and badminton, and staying active through exercise!</p>
