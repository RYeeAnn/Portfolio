...
function About() {
    ...
    const resumeLink = "https://drive.google.com/file/d/1CtmPbwbyjfLjBsamgp3wf3IVKWODAVje/view?usp=sharing";
                        ...
                        <img className='about__image' src={ryan} alt="Ryan" />
                            <div className="about__information">
                                ...
                                <div className="about__text">
                                    ...
                                    <p>Growing up, I was drawn to automobiles, and I chose a career path deeply intertwined with the world of cars.</p>
                                    <p>As much as I loved cars, I realized that I wanted to keep them as a beloved hobby while finding myself on a new journey as a developer. Initially, I hesitated, thinking it might be too late for me to transition into a new career after dedicating so much time to something else. For years, fear held me back, and I kept pushing aside my dreams. However, I finally mustered the courage to pursue my true passion.</p>
                                    <p>My journey began by dipping my toes into self-learning HTML and CSS. Eventually, I committed all my time and energy to a 12-week intensive web development bootcamp at BrainStation in the summer of 2023. I have been building my skills in JavaScript, React, Express, and MySQL. Along the way, I've grown and evolved, but I'm fully aware that this is just the beginning. The learning will never stop, and I couldn't be more excited about it. My journey as a developer has only just begun, and I'm eager to see where it leads.</p>
                                </div>
                            </div>    
                        </div>
                    </div>
